...
import React, { useState as useState3, useEffect as useEffect3, useRef as useRef3, useMemo as useMemo3 } from 'react';
          ...
          <nav className="nav-center">
            {NAV_ITEMS_3.map(n => {
              ...
              if (usesMega) {
                ...
                const OurWork  = OurWorkMegaMenu3;
                const WhoWeAre = WhoWeAreMegaMenu3;
                const NewsMM   = NewsMegaMenu3;
...
const Hero3 = ({ showDocs, mixedWeight, videoSrc, heroImageSrc, docsVariant = "stack" }) => {
  useInView3();
  const page3IsHome8 = false;
  const page3IsHome9 = false;
